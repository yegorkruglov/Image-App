...
final class NetworkManager {
    ...
    func searchPhotosFor(query: String, page: Int) async throws -> SearchResults {
        guard let url = URL(string: "https://api.unsplash.com/search/photos?client_id=\(apiKey)&page=\(page)&per_page=20&query=\(query)") else {
            throw NetworkError.invalidURL
         }
